...
namespace Data.Migrations
{
    ...
    [Migration("20211020125713_CityAndProvinces")]
    partial class CityAndProvinces
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Product.Customers.CustomerProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Entities.System.Consulting", b =>
                {
                    ...
                    b.Property<int>("ConsultingStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Product.Customers.DynamicPricing.ExactPricingValue", b =>
                {
                    ...
                    b.HasOne("Entities.Product.Customers.CustomerProduct", "CustomerProduct")
            ...
            modelBuilder.Entity("Entities.Product.Customers.DynamicPricing.FastPricingDD", b =>
                {
                    b.HasOne("Entities.Product.Customers.DynamicPricing.FastPricingKey", null)
            ...
            modelBuilder.Entity("Entities.Product.Customers.DynamicPricing.FastPricingKey", b =>
                {
                    ...
                    b.HasOne("Entities.Product.Product", "Product")
                        .WithOne("FastPricingKey")
                        .HasForeignKey("Entities.Product.Customers.DynamicPricing.FastPricingKey", "ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.Product.Customers.DynamicPricing.FastPricingValue", b =>
                {
                    ...
                    b.HasOne("Entities.Product.Customers.CustomerProduct", "CustomerProduct")
                        .WithOne("FastPricingValue")
                        .HasForeignKey("Entities.Product.Customers.DynamicPricing.FastPricingValue", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.Product.Dynamic.PropertyValue", b =>
                {
                    b.HasOne("Entities.Product.Customers.CustomerProduct", null)
